...
* ## ������� ���������
  * ### ����������
    ...
    ������� ���������� (� ������������� � ����� �����, � �� ����� ����� � ����):
    ```c++
    const int ci = 10;       // ������ cosnt int (�� ���������)
    const int *pc = &ci;     // p� - ��������� �� ���������� ci
    int i;                   // i - ������ int (�� ���������)
    int *p;                  // p - ��������� (�� ����������������)
    ...
    ```c++
    int *ptr; // ��-��������� �������� � nullptr (zero initialization)
              // ������: nullptr �������� ���� �������������������� ���������� �� static storage duration
    
    int main() {
        int *another_ptr; // ��������� �� ��������� ����� � ������ (Invalid ���������)
    }
    ```
  ...
  * ### �������������
    ...
    ```
    >_���������:_ ��� ������ �������� �������� ������ ��-�� [����������� ����������](https://en.cppreference.com/w/cpp/language/operator_precedence).
  * ### ������ ������
...
* ## ���������� ����������� ������
  ...
  void add_after(node& a, node&  b) {          // ���������� �������� ����� a � a->next
      b.next = a.next;                         // �������, ��� ��������� �� b ������� - ��� ��������� �� a � ������� �������
      if (b.next != nullptr) {                 // ������������� nullptr - UB
          b.next->prev = &b;                   // ��������� ��������� �� ������� ������ ����� ��������� �� b
      }                                                                               
      a.next = &b;                             // ��� �������: ��������� �� a ������ b
      b.prev = &a;                             // ���� �������: ���������� �� b - ��� a
  ...
  void add_before(node& a, node& b) {          // ���������� �������� b ����� a->prev � a
      b.prev = a.prev;                         // ������� ����� b ������ - ��� ������� ����� a � �������
      if (b.prev != nullptr) {                 // ������������� nullptr - UB
          b.prev->next = &b;                   // ��������� ��������� �� ������ ����� �������� ����� b
      }
      b.next = &a;                             // ��� �������: ��������� �� b - ������ a
      a.prev = &b;                             // ���� �������: ��������� �� a - ������ b
  ...
  void remove(node& a) {                       // �������� �������� a 
      if (a.prev != nullptr) {                 // ���� ���� ������� ����� a, �� ������� ���
          a.prev->next = a.next;               // ��������� ��������� �� ���������� �� ���������� ���������
      }
      if (a.next != nullptr) {                 // ���� ���� ������� ����� a, �� ������� ���
          a.next->prev = a.prev;               // ��������� ��������� �� ������� ���� �������� �� a
      }		
  }
  ...
  void print_list(node& head) {                // ����� ������: �� ���������������
      node *cur = &head;
      while (cur != nullptr) {                 // ����������, ���� ������� ���������� - �� ����� ������
          std::cout << cur->data << " ";       // ������� �������� ����������� head
          cur = cur->next;                     // ������ head - ��� ��������� �� head �������
      }
      std::cout << "\n";                       // ����� ������ �������, ������ ��� ������ �� � ���
  }
  
  int main() {
      node a{10}, b{20}, c{30}, d{40}, e{15};  // �������� ��������� � �� ���������� �������� add-�������
      add_after(a, b);
      add_after(b, c);
      add_before(b, e);
      add_after(c, d);      
...
* ## ������� ���������
  ...
  >_���������2:_ �� cppreference [��������](https://en.cppreference.com/book/pointers#:~:text=Special%20null%20pointer),
    ��� `foo(NULL)` ����� �������� `foo(long)`, �� � ���� ��� ����� ������������� � ����� ��������� ����������� ���� ������ ����������.
  
  > _����������3 (�� ��):_ ����� � ���� ��� ���������� ������ `g++ -std=c++17/03/11` g++ ��������� ��������������, ��� `NULL` ��������� � �����, ��� ���� `clang++` ������ ������ �� ���������. 
...
* ## ������� ������ �� ����������
  ...
  * ### �������� � �����������
    ...
    int main() {
      std::vector<int*> v_ptr(10);       // ��������� ������ �� 10 ������� ����������
      std::vector<int&> v_ref(10);       // compilation error: � ������� �������
    }
    ```
...
* ## ���������� ����������
  ...
  * ### �������� `+`, `++`, `-`, `--` ���������� � `int`
    ...
    int main() {
      ...
      int *ub1 = data - 1;              // UB: ����� �� ������� �������
      int *ub2 = data - 1 + 1;          // UB: � ������������� ����������� � ��� ��������� UB (��������� data - 1)
      int *ub3 = data + 5;              // UB: ����� ������� ������ 
      int *not_ub = data + 4;           // �� UB: - one-past-the-last (��� ���� � ��������� ������)
      ...
      std::ptrdiff_t diff = r - q;      // std::ptrdiff_t - ���, � ������� ������ ��� ������ �� �����
      assert(diff == -2);
      assert(&data[0] - &data[2] == -2);
  
      assert(data[1] == *(data + 1));  // �� �����������, �������������� ����� ��� �������� (not vectors).
  ...
  * ### `one-past-the-last`
    ...
    int main() {
      ...
      // int var = *one_past_end;                     // ������������� - UB.
        
      Foo a;
      int *val = &a.x;
      val++;                                          // ��������� (ope-past-the-last)
      // *val;                                        // ������������� - UB
    }
    ```
  * ### ��������� ����������
    ...
    int main() {
      ...
      }
      {
        Foo f;
        std::cout << &f.b - &f.a << "\n";  // UB: �� ������
        assert(&f.a < &f.b);  // ok: ����� � ����� ������� ������� (private/protected/public) �����������
        assert(&f.a != &f.b);  // ok: ������ int
      }
      {
        std::set<int*> s;
        int a = 10, b = 20;
...
* ## C-style-strings/ASCIIZ-������/������ � ����� ��
  ...
  * ### ��������� � ��������� �����
    ...
    bool is_less(char* a, char* b) {
      for (int i = 0; a[i] || b[i]; i++) {           // (a[i] || b[i]) - ������� ������ ��������� � false, ��������� - � true
        if (a[i] != b[i]) {
          return a[i] < b[i];
        }
      }
  ...
  * ### ��������� ������, ���������, ������������
    ...
    char* strcat(cosnt char* a, const char* b) {
      char* res = new char[std::strlen(a) + std::strlen(b) + 1]; // +1 ��� '\0'.
      int res_len = 0;
      for (int i = 0; a[i]; i++) {
        res[res_len++] = a[i];
      }
